...
React-এ State হলো একটি কম্পোনেন্টের নিজস্ব, পরিবর্তনযোগ্য (mutable) ডাটা যা কম্পোনেন্টের ভেতরেই ম্যানেজ করা হয় [৩, ৪]। অন্যদিকে, Props (properties) হলো অভিভাবক (parent) কম্পোনেন্ট থেকে চাইল্ড কম্পোনেন্টে পাঠানো অপরিবর্তনীয় (immutable) ডাটা [১, ৪]। প্রধান পার্থক্য হলো, স্টেট কম্পোনেন্ট নিজে আপডেট করতে পারে, কিন্তু প্রপস শুধু রিড-অনলি (read-only) হিসেবে ব্যবহৃত হয়
...
•	Redux/Zustand: অনেক বড় প্রজেক্ট হলে আলাদা লাইব্রেরি ব্যবহার করে স্টেট ম্যানেজ করা হয়।
