      ...
      {/* Resolved Card */}
        ...
        bg-linear-to-r from-[#22c55e] to-[#14532d] relative overflow-hidden">
            ...
            <div class="z-10 text-center">
                ...
                <h1 class="text-sm lg:text-8xl font-bold mt-2">{resolved}</h1>
            </div>
            ...
            {/* Main Section Start  */}
        <Main_Section progress={progress} SetProgress={SetProgress} cards={cardS} resolved={resolved} SetResolved={SetResolved}></Main_Section>
